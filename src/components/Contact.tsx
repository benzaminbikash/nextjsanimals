            ...
            <div className="w-1/2 p-2">
              <div className="relative">
                <input
                  ...
                  id="name"
                  name="name"
                  className="peer w-full rounded border border-gray-700 bg-black bg-opacity-40 py-1 px-3 text-base leading-8 text-gray-100 placeholder-transparent outline-none transition-colors duration-200 ease-in-out focus:border-indigo-500  focus:ring-2 focus:ring-indigo-900"
                  placeholder="Name"
                />
            ...
            <div className="w-1/2 p-2">
              <div className="relative">
                <input
                  ...
                  id="email"
                  name="email"
                  className="peer w-full rounded border border-gray-700  bg-opacity-40 bg-black py-1 px-3 text-base leading-8 text-gray-100 placeholder-transparent outline-none transition-colors duration-200 ease-in-out focus:border-indigo-500  focus:ring-2 focus:ring-indigo-900"
                  placeholder="Email"
                />
                <label className="absolute left-3 -top-6 bg-transparent text-sm leading-7 text-indigo-500 transition-all peer-placeholder-shown:left-3 peer-placeholder-shown:top-2  peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-500 peer-focus:left-3 peer-focus:-top-6 peer-focus:text-sm peer-focus:text-indigo-500">
                  Email
