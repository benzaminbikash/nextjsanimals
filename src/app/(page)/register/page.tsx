      ...
      <div className="min-h-screen flex flex-col items-center justify-center">
        <div className="grid md:grid-cols-2 items-center gap-4 max-w-6xl w-full p-4 m-4 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md">
          <div className="md:max-w-md w-full sm:px-6 py-4">
            <form action="" onSubmit={handleSubmit(handleForm)} noValidate>
              <div className="mb-12">
              ...
              <div>
                <label className=" block mt-8 mb-2">Email</label>
                <div className="relative flex items-center">
                  <input
                    type="text"
                    className="w-full text-black  border-b border-gray-300 focus:border-[#333] px-2 py-3 outline-none"
                ...
                {error == "Email Already Exits" && (
                  <p className="text-red-500">Email already exit.</p>
                )}
              </div>
              <div className="mt-8">
              ...
              <p className="my-8  text-gray-400 text-center">
                or continue with
              </p>
          ...
          <div className="md:h-full max-md:mt-10 bg-indigo-500 rounded-xl lg:p-12 p-8">
            <img
              src="register.png"
